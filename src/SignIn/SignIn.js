                ...
                <form>
                    <div className="form-group">
                        <div className="input-group">
                            <input type="text" className="form-control" value={this.state.email} placeholder="User Name" />
                    ...
                    <div>
                        <button type="button" className={'btn' + ' ' + classes.submitbutton + ' ' + classes.marginButton} onClick={this.onSubmitHandler}>Login</button>
